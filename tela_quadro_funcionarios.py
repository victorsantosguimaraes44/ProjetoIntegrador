...
from tela_cadastrar_profissional import obter_cadastros

def tela_lista_funcionarios(JANELA):
    ...
    list_label = ctk.CTkLabel(master=frame,text="Quadro de funcionários", font=('Arial', 25, 'bold'))
