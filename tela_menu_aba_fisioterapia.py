...
def abrir_menu_aba_fisioterapia():
    ...
    def aluno(frame):
        ...
        btn_lista_alunos = ctk.CTkButton(master=frame, text="Lista de pacientes", font=("Arial", 15) ,width=150, height=40, corner_radius=20,fg_color="#4CAF50" , hover_color= "#45a049", command=lista_alunos)
        btn_lista_alunos.pack(pady=10)
    
    btn_aluno = ctk.CTkButton(master=frame_lateral, text="Paciente", font=("Arial", 15) ,width=150, height=40, corner_radius=20,fg_color="#4CAF50" , hover_color= "#45a049", command=buttonClick1)
    btn_aluno.pack(pady=10)

    btn_consulta = ctk.CTkButton(master=frame_lateral, text="Agendamento", font=("Arial", 15) ,width=150, height=40, corner_radius=20,fg_color="#4CAF50" , hover_color= "#45a049", command=buttonClick)
