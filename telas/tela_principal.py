...
from telas.tela_inicio import abrir_inicio
from telas.tela_menu_aba_fisioterapia import abrir_menu_aba_fisioterapia
from telas.tela_menu_aba_pilates import abrir_menu_pilates
...
def abrir_tela_principal():
    ...
    icone_home = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\home.png'), size=(25, 25))
    ...
    icone_physio = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\physical-therapy.png'), size=(25, 25))
    ...
    icone_pilates = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\pilates.png'), size=(25, 25))
    ...
    icone_manager = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\profile.png'), size=(25, 25))
    ...
    icone_user = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\logout.png'), size=(25, 25))
