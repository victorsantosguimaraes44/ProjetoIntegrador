...
from telas.tela_cadastro_usuario_fisioterapia import abrir_cadastro_fisioterapia
from database.crud_pacientes import buscar_paciente
from database.crud_pacientes import deletar_paciente
from database.crud_pacientes import atualizar_paciente
from database.crud_pacientes import pesquisar_paciente
...
def tela_lista_pacientes_fisio(JANELA):
    ...
    add_user_img = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\add-user.png'), size=(25, 25))
    ...
    trash_img = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\trash.png'), size=(25, 25))
