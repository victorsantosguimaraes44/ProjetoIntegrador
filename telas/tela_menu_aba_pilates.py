...
from telas.tela_lista_alunos_pilates import tela_lista_alunos_pilates
from telas.tela_agendamentos_pilates import tela_agendamentos_pilates
from database.crud_alunos import buscar_alunos, pesquisar_aluno
from database.crud_agendamento_pilates import buscar_agendamentos_p, pesquisar_ag_p
def abrir_menu_pilates(JANELA):
    ...
    tela_lista_alunos_pilates(frame_tl_ls_p_f)
    ...
    tela_agendamentos_pilates(frame_tl_ag_f)
