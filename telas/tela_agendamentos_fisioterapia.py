...
from telas.tela_agendar_consultas import agendar_consultas
from database.crud_agendamentos_fisioterapia import buscar_agendamento_f, deletar_agendamento_f, atualizar_agendamento
...
def tela_agendamentos_fisio(JANELA):
    ...
    agendar_img = ctk.CTkImage(Image.open(PASTA_ANTERIOR + r'\icones\agendar_img.png'), size=(25, 25))
