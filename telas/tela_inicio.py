...
def abrir_inicio(JANELA_INICIO):
    ...
    imagem2 = ctk.CTkImage(
        light_image=Image.open(PASTA_ANTERIOR + r'\imagens\pilates_1.png'),
        dark_image=Image.open(PASTA_ANTERIOR + r'\imagens\pilates_1.png'),
        size=(375, 325)
    )
    ...
    imagem3 = ctk.CTkImage(
        light_image=Image.open(PASTA_ANTERIOR + r'\imagens\fisio1.png'),
        dark_image=Image.open(PASTA_ANTERIOR + r'\imagens\fisio1.png'),
        size=(375, 325)
    )
